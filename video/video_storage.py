...
@task(cache_key_fn=task_input_hash)
def gcs_upload_file(local_file_path: str, gcs_base: str) -> str:
    logger = get_run_logger()
...
if __name__ == "__main__":
    ...
    def download():
        s3_download_file(
            "ch14-daily-recordings",
            "FULL-2023-04-21--00-29-38--to--2023-04-21--18-30-02.mkv",
            "/Users/rantav/Downloads/",
        )
